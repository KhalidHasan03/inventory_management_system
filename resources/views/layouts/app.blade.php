    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" :class="sidebarOpen ? 'active' : ''" class="w-72 bg-dark-950 border-r border-dark-800 fixed h-full z-50 mobile-sidebar transition-smooth overflow-y-auto">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('dashboard') ? 'sidebar-active text-white' : '' }}">
                    <i class="fas fa-chart-pie w-5 text-center"></i>
                    <span class="font-medium">Dashboard</span>
                </a>

                <a href="{{ route('pos.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('pos.*') ? 'sidebar-active text-white' : '' }}">
                    <i class="fas fa-cash-register w-5 text-center"></i>
                    <span class="font-medium">POS System</span>
                </a>

                <a href="{{ route('orders.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('orders.*') ? 'sidebar-active text-white' : '' }}">
                    <i class="fas fa-shopping-bag w-5 text-center"></i>
                    <span class="font-medium">Orders</span>
                </a>

                <a href="{{ route('products.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('products.*') ? 'sidebar-active text-white' : '' }}">
                    <i class="fas fa-box w-5 text-center"></i>
                    <span class="font-medium">Products</span>
                </a>

                <a href="{{ route('categories.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('categories.*') ? 'sidebar-active text-white' : '' }}">
                ...
                <a href="{{ route('customers.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('customers.*') ? 'sidebar-active text-white' : '' }}">
                    <i class="fas fa-users w-5 text-center"></i>
                    <span class="font-medium">Customers</span>
                </a>

                <a href="{{ route('employees.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('employees.*') ? 'sidebar-active text-white' : '' }}">
                    <i class="fas fa-user-tie w-5 text-center"></i>
                    <span class="font-medium">Employees</span>
                </a>

                <a href="{{ route('suppliers.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('suppliers.*') ? 'sidebar-active text-white' : '' }}">
                ...
                <a href="{{ route('salaries.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('salaries.*') ? 'sidebar-active text-white' : '' }}">
                    <i class="fas fa-money-bill-wave w-5 text-center"></i>
                    <span class="font-medium">Salaries</span>
                </a>

                <a href="{{ route('expenses.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('expenses.*') ? 'sidebar-active text-white' : '' }}">
                    <i class="fas fa-file-invoice-dollar w-5 text-center"></i>
                    <span class="font-medium">Expenses</span>
                </a>

                <a href="{{ route('reports.sales') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-dark-300 hover:bg-dark-800 hover:text-white transition-smooth {{ request()->routeIs('reports.*') ? 'sidebar-active text-white' : '' }}">
        ...
        <main class="flex-1 lg:ml-72 p-4 lg:p-8 pt-16 lg:pt-8">
            ...
            <header class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 mb-6 lg:mb-8">
                <div>
                    ...
                    <p class="text-dark-400 text-sm mt-1">Welcome back, {{ Auth::user()->name }}</p>
                </div>
