...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6 mb-4 lg:mb-8">
    <div class="bg-dark-800 border border-dark-700 rounded-xl p-3 lg:p-6 hover:border-yellow-500/50 transition-smooth">
        ...
        <p class="text-lg lg:text-2xl font-bold text-white mt-1">${{ number_format($todaySales, 2) }}</p>
    </div>
    ...
    <div class="bg-dark-800 border border-dark-700 rounded-xl p-3 lg:p-6 hover:border-yellow-500/50 transition-smooth">
        ...
        <p class="text-lg lg:text-2xl font-bold text-white mt-1">${{ number_format($totalSales, 2) }}</p>
    </div>
    ...
    <div class="bg-dark-800 border border-dark-700 rounded-xl p-3 lg:p-6 hover:border-yellow-500/50 transition-smooth">
        ...
        <p class="text-lg lg:text-2xl font-bold text-white mt-1">{{ number_format($totalCustomers) }}</p>
    </div>
    ...
    <div class="bg-dark-800 border border-dark-700 rounded-xl p-3 lg:p-6 hover:border-yellow-500/50 transition-smooth">
        ...
        <p class="text-lg lg:text-2xl font-bold text-white mt-1">{{ number_format($totalOrders) }}</p>
    </div>
</div>
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6 mb-4 lg:mb-8">
    <div class="bg-dark-800 border border-dark-700 rounded-xl p-3 lg:p-6 hover:border-yellow-500/50 transition-smooth">
        ...
        <p class="text-lg lg:text-2xl font-bold text-white mt-1">{{ number_format($totalProducts) }}</p>
    </div>
    ...
    <div class="bg-dark-800 border border-dark-700 rounded-xl p-3 lg:p-6 hover:border-yellow-500/50 transition-smooth">
        ...
        <p class="text-lg lg:text-2xl font-bold text-white mt-1">{{ number_format($totalCategories) }}</p>
    </div>
    ...
    <div class="bg-dark-800 border border-dark-700 rounded-xl p-3 lg:p-6 hover:border-yellow-500/50 transition-smooth">
        ...
        <p class="text-lg lg:text-2xl font-bold text-white mt-1">{{ number_format($totalSuppliers) }}</p>
    </div>
    ...
    <div class="bg-dark-800 border border-dark-700 rounded-xl p-3 lg:p-6 hover:border-yellow-500/50 transition-smooth">
        ...
        <p class="text-lg lg:text-2xl font-bold text-white mt-1">{{ number_format($totalEmployees) }}</p>
    </div>
</div>
    ...
    <div class="bg-dark-800 border border-dark-700 rounded-xl p-4 lg:p-6">
        ...
        <div class="space-y-3">
            <div class="flex items-center justify-between p-2 lg:p-3 bg-dark-700/50 rounded-lg">
                ...
                <span class="text-white font-semibold text-xs lg:text-sm">{{ $totalProducts }}</span>
            </div>
            <div class="flex items-center justify-between p-2 lg:p-3 bg-dark-700/50 rounded-lg">
                <div class="flex items-center gap-2">
                ...
                <span class="text-white font-semibold text-xs lg:text-sm">{{ $totalCategories }}</span>
            </div>
            <div class="flex items-center justify-between p-2 lg:p-3 bg-dark-700/50 rounded-lg">
                <div class="flex items-center gap-2">
                ...
                <span class="text-white font-semibold text-xs lg:text-sm">{{ $totalSuppliers }}</span>
            </div>
            <div class="flex items-center justify-between p-2 lg:p-3 bg-dark-700/50 rounded-lg">
                <div class="flex items-center gap-2">
                ...
                <span class="text-white font-semibold text-xs lg:text-sm">{{ $totalEmployees }}</span>
            </div>
            <div class="flex items-center justify-between p-2 lg:p-3 bg-dark-700/50 rounded-lg">
                <div class="flex items-center gap-2">
                ...
                <span class="text-red-400 font-semibold text-xs lg:text-sm">${{ number_format($totalExpenses, 2) }}</span>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-dark-800 border border-dark-700 rounded-xl p-4 lg:p-6">
    <div class="flex items-center justify-between mb-4 lg:mb-6">
        ...
        <a href="{{ route('orders.index') }}" class="text-yellow-500 hover:text-yellow-400 text-xs lg:text-sm font-medium">View All <i class="fas fa-arrow-right ml-1"></i></a>
    </div>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-dark-700">
                ...
                <tr class="hover:bg-dark-700/30 transition-smooth">
                    <td class="py-2 lg:py-3"><span class="text-white font-medium text-xs lg:text-sm">{{ $order->invoice_no }}</span></td>
                    <td class="py-2 lg:py-3 hidden sm:table-cell"><span class="text-dark-300 text-xs lg:text-sm">{{ $order->customer->name }}</span></td>
                    <td class="py-2 lg:py-3"><span class="text-white font-semibold text-xs lg:text-sm">${{ number_format($order->grand_total, 2) }}</span></td>
                    <td class="py-2 lg:py-3 hidden xs:table-cell">
                        <span class="px-2 py-0.5 lg:py-1 rounded-full text-xs font-medium {{ $order->status === 'completed' ? 'bg-emerald-500/20 text-emerald-400' : ($order->status === 'pending' ? 'bg-yellow-500/20 text-yellow-400' : 'bg-red-500/20 text-red-400') }}">
                            {{ ucfirst($order->status) }}
                        </span>
                    </td>
                    <td class="py-2 lg:py-3 hidden md:table-cell"><span class="text-dark-400 text-xs">{{ $order->order_date }}</span></td>
                    <td class="py-2 lg:py-3">
                        <a href="{{ route('orders.show', $order->id) }}" class="text-yellow-500 hover:text-yellow-400"><i class="fas fa-eye text-xs lg:text-sm"></i></a>
                    </td>
                </tr>
                @empty
                <tr>
